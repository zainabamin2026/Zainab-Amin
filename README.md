...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Health Data Science Focus Section */
        .health-focus {
...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="#health-focus">Health Data Science</a></li>
        ...
        <div class="container">
            <div class="header-content">
                <div class="profile-container">
                    ...
                    <p class="intro-text">I am a final-year Pharm.D student driven by the purpose of making the world healthier. I am passionate about health data science, and leveraging AI to advance healthcare solutions.</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text">
                    ...
                    <p>My journey in pharmacy has equipped me with deep insights into patient care, medication therapy, and healthcare systems. Combined with my technical skills in Python, R, SQL, and data analysis, I aim to develop solutions that optimize healthcare delivery and improve patient outcomes through health data science.</p>
                    <p>I believe that the future of healthcare lies at the intersection of clinical knowledge and data science, and I'm committed to being at the forefront of this transformation through health data science.</p>
    ...
    <section id="health-focus" class="health-focus">
        <div class="container">
            <h2 class="section-title">Health Data Science Focus</h2>
            <div class="focus-container">
                <div class="focus-item">
                    <div class="focus-icon">
                        <i class="fas fa-database"></i>
                    </div>
                    <h3 class="focus-title">Health Data Analytics</h3>
                    <p>Applying data analysis, machine learning, and statistical modeling to extract insights from healthcare data for improved decision-making and patient outcomes.</p>
                </div>
                <div class="focus-item">
                    <div class="focus-icon">
    ...
    <section id="skills" class="section-medium">
        <div class="container">
            ...
            <div class="skills-container">
                ...
                <div class="skill-category">
                    <h3><i class="fas fa-database"></i> Health Data Science</h3>
                    <div class="skills-list">
            ...
            <div class="projects-grid">
                ...
                <div class="project-card">
                    ...
                    <div class="project-content">
                        ...
                        <p class="project-description">Demonstrates readiness for real-world health data science applications with features including drug information retrieval, dosage calculations, and interaction checking.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="container">
            <p>&copy; 2026 Zainab Amin | Pharm.D Student</p>
        </div>
    </footer>
